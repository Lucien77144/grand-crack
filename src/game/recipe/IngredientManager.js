...
export default class IngredientManager {
	...
	async spawnIngredient() {
		...
		if (ingredientNames.length > 0) {
			...
			if (spawnableIngredients.length > 0) {
				...
				const ingredient = new Ingredient(this, recipeIngredient.name, recipeIngredient.texture, x, recipeIngredient.canMove, recipeIngredient.action, recipeIngredient.isCooked)
	...
	update(dt) {
		...
		console.log(this.#ingredientsSpawned)
	}
